...
def generate_password(
    min_len=10, max_len=30, vals=string.ascii_letters + string.digits
) -> str:
...
def return_user_data() -> tuple[str, str]:
    ...
    name_and_lastname = (
        generate_password(min_len=5, max_len=10, vals=string.ascii_lowercase)
        .join(generate_name_and_lastname())
        .lower()
    )
